...
class SleepTrackerFragment : Fragment() {
    ...
    private lateinit var sleepViewModel: SleepTrackerViewModel
    ...
    override fun onCreateView(
        ...
        sleepViewModel.navigateToSleepQuality.observe(viewLifecycleOwner) { sleepNight ->
            sleepNight?.let {
